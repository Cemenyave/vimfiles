...
" Generated by http://bytefluent.com/vivify 2014-05-18
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi mbenormal guifg=#b096cf guibg=#2e3f2f guisp=#2e3f2f gui=NONE ctermfg=140 ctermbg=237 cterm=NONE
hi perlspecialstring guifg=#68d0a6 guibg=#403f40 guisp=#403f40 gui=NONE ctermfg=79 ctermbg=238 cterm=NONE
hi doxygenspecial guifg=#b775fd guibg=NONE guisp=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi mbechanged guifg=#d6eeea guibg=#2e3f2f guisp=#2e3f2f gui=NONE ctermfg=195 ctermbg=237 cterm=NONE
hi mbevisiblechanged guifg=#d6eeea guibg=#528f46 guisp=#528f46 gui=NONE ctermfg=195 ctermbg=65 cterm=NONE
hi doxygenparam guifg=#b775fd guibg=NONE guisp=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi doxygensmallspecial guifg=#b775fd guibg=NONE guisp=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi doxygenprev guifg=#b775fd guibg=NONE guisp=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi perlspecialmatch guifg=#68d0a6 guibg=#403f40 guisp=#403f40 gui=NONE ctermfg=79 ctermbg=238 cterm=NONE
hi cformat guifg=#68d0a6 guibg=#403f40 guisp=#403f40 gui=NONE ctermfg=79 ctermbg=238 cterm=NONE
hi lcursor guifg=#403f40 guibg=#ff6a8a guisp=#ff6a8a gui=NONE ctermfg=238 ctermbg=204 cterm=NONE
hi doxygenspecialmultilinedesc guifg=#adacab guibg=NONE guisp=NONE gui=NONE ctermfg=145 ctermbg=NONE cterm=NONE
hi taglisttagname guifg=#8ced66 guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi doxygenbrief guifg=#8244fd guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi mbevisiblenormal guifg=#c7b5cf guibg=#528f46 guisp=#528f46 gui=NONE ctermfg=182 ctermbg=65 cterm=NONE
hi user2 guifg=#60a095 guibg=#395e35 guisp=#395e35 gui=NONE ctermfg=73 ctermbg=65 cterm=NONE
hi user1 guifg=#ffeddd guibg=#395e35 guisp=#395e35 gui=NONE ctermfg=224 ctermbg=65 cterm=NONE
hi doxygenspecialonelinedesc guifg=#adacab guibg=NONE guisp=NONE gui=NONE ctermfg=145 ctermbg=NONE cterm=NONE
hi doxygencomment guifg=#13ad93 guibg=NONE guisp=NONE gui=NONE ctermfg=36 ctermbg=NONE cterm=NONE
hi cspecialcharacter guifg=#68d0a6 guibg=#403f40 guisp=#403f40 gui=NONE ctermfg=79 ctermbg=238 cterm=NONE
hi pythonimport guifg=#908486 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#d8f0ec guibg=NONE guisp=NONE gui=NONE ctermfg=195 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#908486 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#71a29b guibg=NONE guisp=NONE gui=NONE ctermfg=109 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#908486 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE
hi stringdelimiter guifg=#662d60 guibg=NONE guisp=NONE gui=NONE ctermfg=53 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#c6ddd9 guibg=NONE guisp=NONE gui=NONE ctermfg=152 ctermbg=NONE cterm=NONE
hi string guifg=#ad5da8 guibg=NONE guisp=NONE gui=NONE ctermfg=133 ctermbg=NONE cterm=NONE
hi constant guifg=#3c34cf guibg=NONE guisp=NONE gui=NONE ctermfg=62 ctermbg=NONE cterm=NONE
hi normal guifg=#e0bbe8 guibg=#151515 guisp=#151515 gui=NONE ctermfg=182 ctermbg=233 cterm=NONE
hi rubyinstancevariable guifg=#9cfea0 guibg=NONE guisp=NONE gui=NONE ctermfg=157 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#76993b guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE
hi identifier guifg=#9eeea7 guibg=NONE guisp=NONE gui=NONE ctermfg=157 ctermbg=NONE cterm=NONE
hi comment guifg=#778788 guibg=NONE guisp=NONE gui=italic ctermfg=66 ctermbg=NONE cterm=NONE
hi rubyregexpdelimiter guifg=#576361 guibg=NONE guisp=NONE gui=NONE ctermfg=241 ctermbg=NONE cterm=NONE
hi rubyregexpspecial guifg=#96a4a0 guibg=NONE guisp=NONE gui=NONE ctermfg=109 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#405bde guibg=NONE guisp=NONE gui=NONE ctermfg=68 ctermbg=NONE cterm=NONE
hi function guifg=#b061fa guibg=NONE guisp=NONE gui=NONE ctermfg=135 ctermbg=NONE cterm=NONE
hi directory guifg=#be70da guibg=NONE guisp=NONE gui=NONE ctermfg=134 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#95d669 guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#89c660 guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi rubyidentifier guifg=#9cfea0 guibg=NONE guisp=NONE gui=NONE ctermfg=157 ctermbg=NONE cterm=NONE
hi condtional guifg=#ffe76e guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE
...
hi pythonbuiltin guifg=#969374 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#e4e5cb guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#e4e5cb guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#e4e5cb guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#e4e5cb guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#e4e5cb guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
